...
| `/struct-write {주제}` | SCQA 기반 보고서/문서 생성 | [write.md](write.md) |
| `/struct-solve {문제}` | 가설 기반 문제 분석 + 해결안 | [solve.md](solve.md) |
| `/struct-express [slide\|memo\|story] {텍스트}` | 슬라이드/메모/스토리 변환 | [express.md](express.md) |
| `/struct-review` | write/solve/express 결과물 Fidelity 검증 게이트 | [review.md](review.md) |
